...
<head>
  ...
  <title>Paiements des frais</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Paiements des frais</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td>@mdo</td>
        <td>@mdo</td>
        <td><button type="submit" class="btn btn-primary btn-xl" id="sendMessageButton">Rembourser</button></td>
      </tr>
      <tr>
        <th scope="row">2</th>
        <td>Jacob</td>
